...
<<<<<<< HEAD
  ...
  searchLocation: async (req, res, next) => {
    ...
    let locationMain = await mainLocation
      .find({ noAccent: { $regex: textSearch, $options: 'i' } })
      .select({ code: 1, _id: 0 }); // search in main location
    let valueMain = locationMain.map(({ code }) => code);
    let locationDetail = await detailLocation
      .find({ noAccent: { $regex: textSearch, $options: 'i' } })
  ...
  getPlanLocation: async (req, res, next) => {
    ...
    if (dataOptimizeDirection) {
      ...
      console.log(arrangeListLocation);
    } else {
      res.send({
        data: [],
        location: location,
...
>>>>>>> 006da765cc652d19ecae5398afe67a733b262d09
  ...
  optimizeRoute: async (req, res) => {
    let { location } = req.body;
    let removeDuplicateLocation = [...new Map(location.map((obj) => [`${obj.title}:${obj.code}`, obj])).values()];
...
const data = [
  {
    ...
    desc:
      'Thành phố với các địa danh thuộc địa của Pháp như Nhà thờ Đức Bà, Bảo tàng chứng tích chiến tranh & các khu chợ nhộn nhịp.',
    data: [
      {
    ...
    plantrip: [
      {
        desc:
          'Chợ nổi tiếng để mua đồ thủ công, lưu niệm, quần áo & hàng hóa khác đồng thời thưởng thức ẩm thực địa phương.',
        title: 'Chợ Bến Thành',
      ...
      {
        desc:
          'Bưu điện trung tâm hoành tráng hoàn thành năm 1891, với sảnh chính có mái vòm & mặt sơn mang dấu ấn thời gian.',
        title: 'Bưu Điện Trung Tâm Thành Phố',
      ...
      {
        desc:
          'Nhà thờ Công giáo được xây dựng bằng gạch Pháp vào những năm 1880 và có các tháp chuông Rô-măng cao 58m.',
        title: 'Nhà thờ Đức Bà Sài Gòn',
      ...
      {
        desc:
          'Quần thể địa đạo rộng lớn từng được sử dụng bởi quân đội Việt Cộng, cùng các vật trưng bày và đài tưởng niệm.',
        title: 'Khu di tích lịch sử Địa Đạo Củ Chi',
  ...
  },
  {
    ...
    plantrip: [
      ...
      {
        desc:
          'Tàn tích của nhà tù nhiều tầng dành cho tù binh ch.tranh Việt Nam chỉ còn lại khu canh gác, nay là bảo tàng.',
        title: 'Di Tích Lịch Sử Nhà Tù Hỏa Lò',
      ...
      {
        desc:
          'Đền Quán Thánh, tên chữ là Trấn Vũ Quán, có từ đời Lý Thái Tổ, thờ Huyền Thiên Trấn Vũ, là một trong bốn vị thần được lập đền thờ để trấn giữ bốn cửa ngõ thành Thăng Long khi xưa.',
  ...
  },
  {
    ...
    desc:
      'Thành phố ven biển được biết đến với Phố Cổ lịch sử, Bảo tàng Gốm sứ, bức tranh ẩm thực & các bãi biển gần đó.',
    data: [
      {
    ...
    plantrip: [
      ...
      {
        desc:
          'Khu di tích nhộn nhịp có cảng thị được bảo tồn và trung tâm thương mại phản ánh sự ảnh hưởng từ nước ngoài.',
        title: 'Phố Cổ Hội An',
  ...
  },
  {
    ...
    desc:
      'Cố đô của triều đình nhà Nguyễn, nơi có Kinh thành được xây dựng từ thế kỷ 19, Hoàng Thành và chùa Thiên Mụ.',
    data: [
      {
    ...
    plantrip: [
      ...
      {
        desc:
          'Cổng chính dẫn vào Hoàng thành được xây năm 1833 có lầu nằm bên trên được sử dụng để tổ chức các nghi lễ.',
        title: 'Ngọ Môn',
      ...
      {
        desc:
          'Ngôi chùa 7 tầng nổi tiếng này là nơi cư trú của các nhà sư, có cảnh quan đẹp, được xây dựng vào năm 1601.',
        title: 'Chùa Thiên Mụ',
      ...
      {
        desc:
          'Cầu Trường Tiền còn được gọi là Cầu Tràng Tiền, là chiếc cầu dài 402,60 m, gồm 6 nhịp dầm thép hình vành lược, khẩu độ mỗi nhịp 67 m.',
        title: 'Cầu Trường Tiền',
      ...
      {
        desc:
          'Núi Ngự Bình, gọi ngắn gọn là núi Ngự, trước có tên là Hòn Mô hay Núi Bằng; là một hòn núi đất cao 103 m ở bờ phải sông Hương, cách trung tâm thành phố Huế 4 km về phía Nam.',
        title: 'núi Ngự Bình',
  ...
  },
  {
    ...
    plantrip: [
      ...
      {
        desc:
          'Ngôi đền 3 tầng thanh bình nằm trên đỉnh núi với 2 tháp nhà thờ là nơi trưng bày hiện vật & hình ảnh lịch sử.',
        title: 'Tháp Bà PoNagar',
  ...
  },
  {
    ...
    plantrip: [
      ...
      {
        desc:
          'Vườn hoa trên đỉnh núi với các thảm hoa khoe sắc, cây cảnh tạo hình nghệ thuật và khu ngắm toàn cảnh Sa Pa.',
        title: 'Vườn hoa Hàm Rồng',
      ...
      {
        desc:
          'Bảo tàng với kiến trúc truyền thống có cửa hàng mỹ nghệ & lưu niệm bán đồ thủ công được làm tại địa phương.',
        title: 'Sapa Museum',
      ...
      {
        desc:
          'Thác nước lớn nên thơ, có thể thấy từ đường lớn, là điểm đến ưa thích của người đi xe đạp và đi bộ đường dài.',
  ...
  },
  {
    ...
    plantrip: [
      {
        desc:
          'Khu trưng bày nghệ thuật với các tác phẩm điêu khắc bằng đất sét khổng lồ đủ thể loại từ thằn lằn đến tàu hỏa.',
        title: 'Đường Hầm Điêu Khắc',
      ...
      {
        desc:
          'Biệt thự cổ quái có kiến trúc mô phỏng thân cây cổ thụ; du khách có thể nhìn toàn cảnh thành phố từ mái nhà.',
        title: 'Biệt thự Hằng Nga',
  ...
  },
  {
    ...
    desc:
      'Đảo Việt Nam có các khu nghỉ mát bãi biển, thị trấn Dương Đông và một công viên quốc gia có núi và rừng rậm.',
  },
  {
    title: 'Mũi Né',
  ...
  },
  {
    ...
    desc:
      'Rừng mưa phòng hộ ở Việt Nam, là nơi có hang đá vôi cổ, hang động lớn như Phong Nha & nhiều động vật hoang dã.',
  },
  {
    title: 'Sa Pa',
  ...
  },
  {
    ...
    desc:
      'Thành phố bên sông nổi tiếng với chợ nổi Cái Răng - Phong Điền cùng chuyến đi thuyền trên đường thủy n.thôn.',
  },
  {
  ...
  },
  {
    ...
    desc:
      'Thành phố cảng & khu nghỉ mát với các bãi biển, nhà thuộc địa Villa Blanche & tượng Jesus 32m trên núi Small.',
  },
  {
    title: 'Hải Phòng',
